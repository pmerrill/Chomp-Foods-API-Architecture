...
## 📖 About Chomp API
The Chomp Foods API is a specialized nutrition engine that goes beyond simple data retrieval. It interprets complex ingredient lists to determine dietary suitability (Vegan, Gluten-Free, etc.) for **900,000+ foods**. This repository documents the legacy high-scale architecture that powers the platform.
